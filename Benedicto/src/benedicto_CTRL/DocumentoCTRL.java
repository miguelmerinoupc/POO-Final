...
public class DocumentoCTRL {
    ...
    public ArrayList<Documento> BuscarMovimiento(Articulo articulo, GrupoEstudio grupo, String numero, DateTime fecEmision, String identificacion, DateTime fecVencimiento, DateTime fecPago, char estado) {
